...
$config['authentication'] = function () {
    if (isset($_SESSION['use_ck']) && $_SESSION['use_ck'] == 1)
        return true;
    else
        return false;
};
...
$config['licenseName'] = 'sale.hyundaiangiang.com';
$config['licenseKey']  = 'Q5U569XHUGFRXVGYJYYUC2C8BMPDC';
...
$config['backends'][] = array(
    ...
    //'root'         => '/dododo/', // Can be used to explicitly set the CKFinder user files directory.
    'chmodFiles'   => 0777,
    'chmodFolders' => 0755,

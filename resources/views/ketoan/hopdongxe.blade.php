    ...
    <div class="content-wrapper">
        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0"><strong>Kế toán</strong></h1>
                    </div><!-- /.col -->
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item"><a href="#">Trang chủ</a></li>
                            <li class="breadcrumb-item active">Kế toán</li>
                            <li class="breadcrumb-item active">Hợp đồng xe</li>
                        </ol>
                    </div><!-- /.col -->
                </div><!-- /.row -->
            </div><!-- /.container-fluid -->
                                        ...
                                        <div class="col-sm-4">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select name="mauHD" class="form-control">
                                                    ...
                                                    <option value="4">Biên bản bàn giao xe</option>
                                                </select>
                                            </div>
                                            <div class="form-group">
...
@section('script')
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            function loadList() {
                $.ajax({
                    url: "management/ketoan/hopdong/danhsach",
                    dataType: "text",
            ...
            function loadTotal(id) {
             ...
             $("#in").click(function(e){
               e.preventDefault();
                ...
                if ($("select[name=mauHD]").val() == 4) {
                    open("{{url('management/ketoan/hopdong/bienban/')}}/" + $("input[name=idHopDong]").val(),"_blank");
                }
            });

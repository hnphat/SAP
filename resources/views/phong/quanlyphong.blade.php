    ...
    <div class="content-wrapper">
        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0"><strong>QUẢN LÝ PHÒNG BAN</strong></h1>
                    </div><!-- /.col -->
                    <div class="col-sm-6">
                                ...
                                <div class="card card-success">
                                    ...
                                    <form id="editForm" autocomplete="off">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="form-group">
                                                <label for="etenPhong">Tên phòng</label>
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                ...
                                <div class="card card-success">
                                    <div class="card-header">
                                        <h3 class="card-title">THÊM NHÂN VIÊN VÀO PHÒNG BAN</h3>
                                    </div>
                                    <!-- /.card-header -->
                                    <!-- form start -->
                                    <form id="addPlusForm" autocomplete="off">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="form-group">
                                                <label for="mtenPhong">Phòng ban</label>
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                ...
                                <div class="card card-success">
                                    <div class="card-header">
                                        <h3 class="card-title">CHỈNH SỬA NHÂN VIÊN PHÒNG BAN</h3>
                                    </div>
                                    <!-- /.card-header -->
                                    <!-- form start -->
                                    <form id="editAddPlusForm" autocomplete="off">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="form-group">
                                                <label for="emtenPhong">Phòng ban</label>
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            var table = $('#dataTable').DataTable({
                ajax: "{{ url('management/phong/getlist/') }}",
                columns: [
                    { "data": "name"},
                    {
                        "data": null,
            ...
            $("#btnAdd").click(function(e){
                ...
                if (!$("input[name=tenPhong]").val()) 
                    alert("Bạn chưa nhập thông tin phòng ban");
                else {
                    $.ajax({
                        url: "{{url('management/phong/add/')}}",
                        type: "POST",
                        dataType: "json",
            ...
            $('#btnUpdate').click(function(e){
                e.preventDefault();
                $.ajax({
                    url: "{{url('management/phong/update')}}",
                    type: 'post',
                    dataType: 'json',
            ...
            $(document).on("click","#delete",function(){
               if (confirm("Bạn có chắc muốn xóa?")) {
                   $.ajax({
                      url: "{{url('management/phong/delete')}}",
                      type: "post",
                      dataType: "json",
                      data: {
                          "_token": "{{csrf_token()}}",
            ...
            $(document).on('click','#more', function(){
                $.get("management/phong/more/" + $(this).data('id'), function(data){
                    $("#showMore").html(data);
                });
            });
            ...
            $(document).on('click', '#deletePlus', function(){
                if (confirm("Bạn có chắc muốn xóa nhân viên này ra khỏi phòng ban?")) {
                    $.ajax({
                        url: "{{url('management/phong/more/delete/')}}",
                        type: "post",
                        dataType: "json",
                        data: {
                            "_token": "{{csrf_token()}}",
                        ...
                        success: function(response){
                            ...
                            $.get("management/phong/more/" + response.id, function(data){
                                $("#showMore").html(data);
                            });
                        },
                        error: function() {
            ...
            $(document).on('click','#addplus', function(){
                $.ajax({
                    url: "{{url('management/phong/more/add/')}}",
                    type: "post",
                    dataType: "json",
                    data: {
                        '_token': "{{csrf_token()}}",
            ...
            $("#btnAddPlus").click(function(e){
                e.preventDefault();
                $.ajax({
                    url: "{{url('management/phong/more/addplus/')}}",
                    type: "POST",
                    dataType: "json",
            ...
            $(document).on('click','#showEditPlus', function(){
                $.ajax({
                    url: "{{url('management/phong/more/editshowplus/')}}",
                    type: "post",
                    dataType: "json",
                    data: {
                        '_token': "{{csrf_token()}}",

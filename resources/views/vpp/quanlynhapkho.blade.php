                ...
                <div class="card-body">
                    <div class="tab-content" id="custom-tabs-one-tabContent">
                        <div class="row">
                            ...
                            <div class="col-md-1">
                                <button id="xemPhieuNhap" type="button" class="btn btn-info btn-xs">Xem</button>
                            </div>
                            <div class="col-md-2">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body"> 
                    <form id="addForm" autocomplete="off">
                        ...
                        <div class="form-group">                               
                            <button id="taoPhieu" type="button" class="btn btn-warning btn-xs">Tạo phiếu</button>
                        </div>  
                        <hr/>
                        <div class="form-group">                               
            ...
            $("#xemPhieuNhap").click(function(e){
                ...
                $.ajax({
                    ...
                    success: function(response) {     
                        ...
                        response.data.forEach((x) => {
                            showrow += `<div class="form-group" id="row_sel_${x.id}">
                                    <div class="row">
                                        <div class="col-md-4">
                                            <label>Hàng hóa</label> 
                                            <select name="rhangHoa${x.id}" disabled class="form-control">
                                                ${danhmuc}
                                            </select>
                                        </div>
                                        <div class="col-md-3">
                                            <label>Số lượng</label> 
                                            <input type="number" disabled name="rsoLuong${x.id}" value="${x.soLuong}" class="form-control">
                                        </div>
                                        <div class="col-md-3">
                                            <label>Đơn giá</label> 
                                            <input type="number" disabled name="rdonGia${x.id}"  value="${x.donGia}" class="form-control">
                                        </div>
                                        <div class="col-md-2">      
                                            <br/>                                
                                            <button id="deleteRow" disabled type="button" class="btn btn-danger btn-sm" data-code="${x.id}">Xóa</button>
                                        </div>
                                    </div>
                                </div>                                                                                              
                                `;
                        });     
                        showrow += `<button type="button" disabled class="btn btn-success">LƯU</button>`;  

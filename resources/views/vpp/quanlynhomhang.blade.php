    ...
    <div class="content-wrapper">
        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0"><strong>Quản lý nhóm hàng</strong></h1>
                    </div><!-- /.col -->
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item"><a href="#">Trang chủ</a></li>
                            <li class="breadcrumb-item active">Hành chính</li>
                            <li class="breadcrumb-item active">Quản lý nhập kho - quản lý nhóm hàng</li>
                        </ol>
                    </div><!-- /.col -->
                </div><!-- /.row -->
            </div><!-- /.container-fluid -->
                        ...
                        <ul class="nav nav-tabs" id="custom-tabs-one-tab" role="tablist">
                            <li class="nav-item">
                                <a class="nav-link active" id="tab-1-tab" data-toggle="pill" href="#tab-1" role="tab" aria-controls="tab-1" aria-selected="false">
                                    <strong>Quản lý nhóm hàng</strong>
                                </a>
                            </li>
                        </ul>
                    </div>
                    ...
                    <div class="modal-body"> 
                        <form id="addForm" autocomplete="off">
                            ...
                            <div class="form-group">
                               ...
                               <input type="text" name="tenNhom" class="form-control" placeholder="Tên nhóm hàng">
                            </div>                          
                        </form>
                    </div>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body"> 
                        <form id="editForm" autocomplete="off">
                            ...
                            <div class="form-group">
                               <label>Tên nhóm hàng</label> 
                               <input type="text" name="etenNhom" class="form-control" placeholder="Tên nhóm hàng">
                            </div>                          
                        </form>
                    </div>
                    <div class="modal-footer justify-content-between">
    ...
    <script>
        ...
        $(document).ready(function() {
            var table = $('#dataTable').DataTable({
                ...
                ajax: "{{ url('management/vpp/quanlynhomhang/loadnhomhang/') }}",
                "columnDefs": [ {
                    "searchable": false,
                    "orderable": false,
                    "targets": 0
            ...
            $("#btnAdd").click(function(e){   
                ...
                $.ajax({
                    type:'POST',
                    url: "{{ url('management/vpp/quanlynhomhang/post/')}}",
                    dataType: "json",
            ...
            $(document).on('click','#btnDelete', function(){
                if(confirm('Bạn có chắc muốn xóa?')) {
                    $.ajax({
                        url: "{{url('management/vpp/quanlynhomhang/delete/')}}",
                        type: "post",
                        dataType: "json",
                        data: {
                            "_token": "{{csrf_token()}}",
            ...
            $(document).on('click','#btnEdit', function(){
                $.ajax({
                    url: "{{url('management/vpp/quanlynhomhang/edit/')}}" + "/" + $(this).data('id'),
                    type: "get",
                    dataType: "json",
                    data: {
                        "_token": "{{csrf_token()}}",
                    ...
                    success: function(response) {
                        ...
                        $("input[name=etenNhom]").val(response.data.tenNhom);
                            Toast.fire({
                                icon: response.type,
                                title: response.message
                            })
            ...
            $("#btnUpdate").click(function(e){
                e.preventDefault();
                $.ajax({
                    url: "{{url('management/vpp/quanlynhomhang/update/')}}",
                    type: "post",
                    dataType: "json",

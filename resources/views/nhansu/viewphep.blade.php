    ...
    <div class="content-wrapper">
        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0"><strong>Quản lý phê duyệt</strong></h1>
                    </div><!-- /.col -->
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item"><a href="#">Trang chủ</a></li>
                            <li class="breadcrumb-item active">Nhân sự</li>
                            <li class="breadcrumb-item active">Quản lý phê duyệt</li>
                        </ol>
                    </div><!-- /.col -->
                </div><!-- /.row -->
            </div><!-- /.container-fluid -->
    ...
    <script>
        ...
        $(document).ready(function() {
            var table = $('#dataTable').DataTable({
                ...
                ajax: "{{ url('management/nhansu/quanlypheduyetphep/ajax/getlist') }}",
                "columnDefs": [ {
                    "searchable": false,
                    "orderable": false,
                    "targets": 0
            ...
            $(document).on('click','#seen', function(){
                if(confirm('Xác nhận đã xem?')) {
                    $.ajax({
                        url: "{{url('management/nhansu/quanlypheduyetphep/ajax/seen/')}}",
                        type: "post",
                        dataType: "json",
                        data: {
                            "_token": "{{csrf_token()}}",

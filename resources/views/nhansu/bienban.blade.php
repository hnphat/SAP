    ...
    <div class="content-wrapper">
        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0"><strong>Quản lý biên bản</strong></h1>
                    </div><!-- /.col -->
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item"><a href="#">Trang chủ</a></li>
                            <li class="breadcrumb-item active">Nhân sự</li>
                            <li class="breadcrumb-item active">Quản lý biên bản</li>
                        </ol>
                    </div><!-- /.col -->
                </div><!-- /.row -->
            </div><!-- /.container-fluid -->
                        ...
                        <ul class="nav nav-tabs" id="custom-tabs-one-tab" role="tablist">
                            <li class="nav-item">
                                <a class="nav-link active" id="tab-1-tab" data-toggle="pill" href="#tab-1" role="tab" aria-controls="tab-1" aria-selected="false">
                                    <strong>Quản lý biên bản</strong>
                                </a>
                            </li>
                        </ul>
                    </div>
            ...
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <div class="modal-header">
                        <h4 class="modal-title">Quản lý biên bản</h4>
    ...
    <script>
        ...
        $(document).ready(function() {
            var table = $('#dataTable').DataTable({
                ...
                ajax: "{{ url('management/nhansu/ajax/loadbienban/') }}",
                "columnDefs": [ {
                    "searchable": false,
                    "orderable": false,
                    "targets": 0
            ...
            $(document).one('click','#btnAdd',function(e){
                ...
                $('#addForm').submit(function(e) {
                    ...
                    $.ajax({
                        type:'POST',
                        url: "{{ url('management/nhansu/ajax/postbienban/')}}",
                        data: formData,
                        cache: false,
                        contentType: false,
                        processData: false,
